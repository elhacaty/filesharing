...
@section('content')
    @if ($count == 0)
        <h3>Không có kết quả phù hợp trả về</h3>
    @else
        @foreach($posts as $post)
            <div class="doc-item-cart">
                <div class="row">
                    <div class="col-md-8">
                        <a onmouseover="" style="cursor: pointer;" onclick="viewCount({{$post->id}})"><h2
                                    style="color: #428bca;">{{$post->title}}</h2></a>
                        ...
                        <a href="http://filesharing.app/{{$post->source}}" target="_blank" style="margin-right: 5px;"
